package com.vbt.apispringboot.config;
...
import com.vbt.apispringboot.dto.AuthorDTO;
import com.vbt.apispringboot.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		sdf.setTimeZone(TimeZone.getTimeZone("GMT")); // Greenwich Time
